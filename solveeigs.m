...
p = 0; % momentum
podd = 1; teven = 1; % quantum number for the parity (p) and time reversal (t) symmetry, could be (podd, teven)=(1,1), (podd, teven)=(0,0), (podd, teven)=(0,-1), (podd, teven)=(-1,-1), with 1=true, 0=false, -1=not impose
...
AfunG = @(x) applytoGp_ncon(x, ALt, ARt, L, R, N, d, D, p, podd, teven);
...
% show the coefficients of the Pauli strings in G, with '0'='I', '1'='X', '2'='Y', '3'='Z'
